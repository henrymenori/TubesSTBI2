...
//     var rpattern = new RegExp("/\.[A|W|T|X|B]/");
//     title = "";
//     author = "";
//     words = "";
//     var j;   
...
//         var line = documents[i];
//         // console.log(line);
//     	if(line === ".T\r"){
//     		j = i;
//     		do{
//     			title = title + documents[j];
//     			j++;
//     		}while(!/\.[A|W|T|X|B][\r|$]/.test(documents[j+1]));
//     	}
//     	else if(line === ".W\r"){
//     		j = i;
//     		do{
//     			words = words + documents[j];
//     			j++;
//     		}
//     		while(!/\.[A|W|T|X|B]\r$/.test(documents[j+2]));
//     	}
//     	else if(line === ".A\r"){
//     		j = i;
//     		while(!/\.[A|W|T|X|B][\r|$]/.test(documents[j+1])){
//     			author = author + documents[j];
//     			j++;
//     		}
//     	}
...
Collection.prototype.balancing = function(query, retrieval, tops) {
	// preprocess query
	var temp;
	var doclength = this.rawdocuments.length;
	var word = [];
...
Collection.prototype.experimental = function(querylocation, relevancelocation, tops) {
	...
	for(var i = 0; i < queries.length; i++) {
		...
		//console.log(temp);
		temp = this.balancing(queries[i], temp, tops);
